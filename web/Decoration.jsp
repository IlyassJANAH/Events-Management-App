...
<div class="row">
    <div class="col-sm-12">
		...
		line-height: 13px;"><i class="fa fa-plus"></i> Ajouter</button>
            ...
            <tr>
                <td data-title="Country" align="left"> <c:out value = "${row.LibelleDecoration}"/></td>
               <td data-title="Country" align="left"> <c:out value = "${row.DesignationDecoration}"/></td>
               <td data-title="Country" align="left"> <c:out value = "${row.PrixDecoration}"/> DH</td>
     
               <td>
                   <a href="http://localhost:8080/Projet_s3/ModifierDecoration.jsp?idDeco=<c:out value = "${row.idDecoration}"/>" id="modifier" class="edit" title="Modifier" data-toggle="tooltip" style="color: #FFC107;"><i class="material-icons">&#xE254;</i></a>
                   <a onclick="Confirmer( <c:out value = "${row.idDecoration}"/>)" class="delete" title="Supprimer" data-toggle="tooltip" style="color: #E34724;"><i class="material-icons">&#xE872;</i></a> 
               </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Ajouter une décoration</h5>
      ...
      <div class="modal-body">
          ...
          <form action="AjouterDecoration" method="post">
...
function Confirmer(id) {
  ...
  if (r == true) {
    window.location.href = "http://localhost:8080/Projet_s3/SupprimerDecoration?idDeco="+id;
  } 
