 ...
 * @author lenovo
 */
@WebServlet(name = "AjouterMenu", urlPatterns = {"/AjouterMenu"})
...
try {
    PreparedStatement pst = con.prepareStatement("INSERT INTO menu(LibelleMenu, PrixMenu ,DesignationMenu) VALUES (?,?,?);");
